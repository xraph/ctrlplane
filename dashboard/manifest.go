...
func buildNav() []contributor.NavItem {
	return []contributor.NavItem{
		...
		{Label: "Workloads", Path: "/workloads", Icon: "boxes", Group: "Infrastructure", Priority: 0},
		{Label: "Instances", Path: "/instances", Icon: "server", Group: "Infrastructure", Priority: 1},
		{Label: "Deployments", Path: "/deployments", Icon: "rocket", Group: "Infrastructure", Priority: 2},
		{Label: "Health", Path: "/health", Icon: "heart-pulse", Group: "Infrastructure", Priority: 3},
		{Label: "Providers", Path: "/providers", Icon: "cloud", Group: "Infrastructure", Priority: 4},
		{Label: "Workers", Path: "/workers", Icon: "settings", Group: "Infrastructure", Priority: 5},
		{Label: "Events", Path: "/events", Icon: "bell", Group: "Infrastructure", Priority: 6},
		{Label: "Templates", Path: "/templates", Icon: "file-text", Group: "Infrastructure", Priority: 7},
		{Label: "Datacenters", Path: "/datacenters", Icon: "map-pin", Group: "Infrastructure", Priority: 8},
